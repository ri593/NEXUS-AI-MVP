...
* 🔇 Mute button (F4 / click) — no more TEROS AI TEROSICA ASSISTANT picking up side conversations
...
Engineered by a 17-year-old building a real TEROS AI TEROSICA ASSISTANT-style assistant.
